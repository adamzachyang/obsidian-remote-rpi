...
## Using the Container
To use this, build the image locally using `docker build . -t obsidian-remote-rpi4`, then run `docker compose up` and the Guacamole desktop and Obsidian should be accessible on the machine IP port 8080.  
